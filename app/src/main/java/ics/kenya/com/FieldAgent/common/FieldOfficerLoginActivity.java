...
public class FieldOfficerLoginActivity extends AppCompatActivity {
    int loginCntr = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.field_oficer_login_activity);
    ...
    public class FetchLogin extends AsyncTask<Void, Void, Void> {
        ...
        private ProgressDialog mprogress = new ProgressDialog(FieldOfficerLoginActivity.this);
        ...
        protected void onPostExecute(Void result) {
            runOnUiThread(new Runnable() {
                public void run() {
                    mprogress.dismiss();
                    Intent intent = new Intent(FieldOfficerLoginActivity.this, FieldAgentDashboardActivity.class);
