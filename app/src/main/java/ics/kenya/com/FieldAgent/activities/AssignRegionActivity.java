...
import ics.kenya.com.FieldAgent.Bus.TraderRegBus;
...
public class AssignRegionActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.assign_region_activity);
    ...
    public class register extends AsyncTask<Void, Void, Void> {
        ...
        private ProgressDialog mprogress = new ProgressDialog(AssignRegionActivity.this);
        ...
        protected void onPostExecute(Void result) {
            runOnUiThread(new Runnable() {
                public void run() {
                    mprogress.dismiss();
                    AlertDialog.Builder alertdialog = new AlertDialog.Builder(AssignRegionActivity.this);
                    ...
                    alertdialog.setPositiveButton("OK",
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent depositsintent = new Intent(getApplicationContext(), FieldAgentDashboardActivity.class);
